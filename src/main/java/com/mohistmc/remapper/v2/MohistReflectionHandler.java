...
import com.mohistmc.remapper.utils.Enumerations;
...
public class MohistReflectionHandler extends ClassLoader {
    ...
    public static Object redirectMethodInvoke(Method method, Object src, Object[] param) throws Throwable {
        Object ret = MohistRedirectAdapter.runRedirect(remapper, method, src, param);
        if (ret != remapper) {
            return ret;
        } else {
    ...
    public static byte[] transformOrAdd(ClassLoader loader, byte[] bytes) {
        ...
        if (rcl != null) {
            ...
            MohistRedirectAdapter.scanMethod(bytes);
            return bytes;
        }
    }
}
